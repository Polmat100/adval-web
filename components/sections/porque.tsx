...
export const PorQue = () => {
  return (
    <section id="porque" style={{ maxWidth: 1280, margin: "0 auto", padding: "96px 36px", color: "var(--titular)", fontFamily: "var(--font-cuerpo), sans-serif" }}>
      <Reveal as="div" style={{ maxWidth: 680, marginBottom: 52 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)" }}>
        {RAZONES.map((r, i) => (
          <Reveal as="div" delay={(i % 2) * 90} key={r.n} style={{ display: "flex", gap: 24, padding: "30px 0", borderBottom: "1px solid var(--borde)" }}>
